...
const components = [
  ...
  // Shadcn-equivalent components
  { name: "Alert Dialog", href: "/components/alert-dialog", icon: ShieldAlert },
  { name: "Aspect Ratio", href: "/components/aspect-ratio", icon: Ratio },
  { name: "Breadcrumb", href: "/components/breadcrumb", icon: Navigation },
  { name: "Calendar", href: "/components/calendar", icon: CalendarDays },
  { name: "Carousel", href: "/components/carousel", icon: GalleryHorizontal },
  { name: "Chart", href: "/components/chart", icon: BarChart },
  { name: "Collapsible", href: "/components/collapsible", icon: ChevronRight },
  { name: "Command", href: "/components/command", icon: Terminal },
  { name: "Context Menu", href: "/components/context-menu", icon: MousePointer2 },
  { name: "Dialog", href: "/components/dialog", icon: Layers },
  { name: "Drawer", href: "/components/drawer", icon: PanelLeftOpen },
  { name: "Dropdown Menu", href: "/components/dropdown-menu", icon: MenuSquare },
  { name: "Form", href: "/components/form", icon: FileText },
  { name: "Hover Card", href: "/components/hover-card", icon: Info },
  { name: "Input OTP", href: "/components/input-otp", icon: KeyRound },
  { name: "Label", href: "/components/label", icon: Tag },
  { name: "Menubar", href: "/components/menubar", icon: MenuSquare },
  { name: "Navigation Menu", href: "/components/navigation-menu", icon: Milestone },
  { name: "Pagination", href: "/components/pagination", icon: Rows3 },
  { name: "Popover", href: "/components/popover", icon: MessageSquare },
  { name: "Radio Group", href: "/components/radio-group", icon: RadioTower },
  { name: "Resizable", href: "/components/resizable", icon: GripVertical },
  { name: "Scroll Area", href: "/components/scroll-area", icon: ScrollText },
  { name: "Separator", href: "/components/separator", icon: SeparatorHorizontal },
  { name: "Sheet", href: "/components/sheet", icon: PanelRight },
  { name: "Sidebar", href: "/components/sidebar", icon: LayoutPanelLeft },
  { name: "Sonner", href: "/components/sonner", icon: BellRing },
  { name: "Switch", href: "/components/switch", icon: SwitchCamera },
  { name: "Table", href: "/components/table", icon: Table2 },
  { name: "Toast", href: "/components/toast", icon: BellRing },
  { name: "Toggle Group", href: "/components/toggle-group", icon: ToggleLeft },
];
